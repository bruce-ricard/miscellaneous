...
\frame{
  ...
  ``Hack'' on public key cryptography

  Use public key cryptography to sign: but ``encrypt'' with private
  key.

  TODO: show little same example as the one from RSA encryption,
  but ``encrypt'' with the private key
}
...
\frame{
  ...
  How do you prove who you are? How do you prove the
  public key is indeed yours?
